...
<c:forEach var="v" items="${post}" varStatus="status">
 <div class="card mb-2 w-100" style="border:#7BBBD6 solid 4px">
                <div class="card-header">
                    <h6 class="card-title"> <a class="text-muted text-uppercase" data-toggle="collapse" href="#question1" style="font-size:25px;"><i class="fa fa-hand-o-right mr-2 mt-0-20 pull-left" aria-hidden="true"></i>${v.p_title}<i class="fa fa-minus mr-2 text-slate pull-right"></i> </a> </h6>
                </div>
                
                <div id="question1" class="collapse show" style="">
                <!-- 데이터 : //테이블에 제목값 , 챌린지내용, -for 시작-->
                    <div class="card-body"> ${v.p_text} </div>
                    <div class="card-footer bg-transparent d-sm-flex align-items-sm-center border-top-0 pt-0"> <span class="text-muted">나알 짜</span>
